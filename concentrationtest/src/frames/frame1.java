...
public class frame1 extends JFrame {
	...
	public frame1() {
		...
		textField_1.setBounds(244, 11, 86, 20);
		contentPane.add(textField_1);
		
		textField_2 = new JTextField();
		textField_2.setColumns(10);
		textField_2.setBounds(244, 41, 86, 20);
		contentPane.add(textField_2);
		
		textField_3 = new JTextField();
		textField_3.setColumns(10);
		textField_3.setBounds(244, 72, 86, 20);
		contentPane.add(textField_3);
		
		textField_4 = new JTextField();
		textField_4.setColumns(10);
		textField_4.setBounds(244, 103, 86, 20);
		contentPane.add(textField_4);
		
		textField_5 = new JTextField();
		textField_5.setColumns(10);
		textField_5.setBounds(244, 134, 86, 20);
		contentPane.add(textField_5);
		
		textField_6 = new JTextField();
		textField_6.setColumns(10);
		textField_6.setBounds(244, 168, 86, 20);
		contentPane.add(textField_6);
		
		JButton btnWeiter = new JButton("weiter");
		btnWeiter.setFont(new Font("Tahoma", Font.PLAIN, 16));
		btnWeiter.setBounds(231, 232, 99, 28);
		contentPane.add(btnWeiter);
		
		JLabel Zeit = new JLabel("Noch: xx Sekunden");
		Zeit.setFont(new Font("Tahoma", Font.BOLD, 16));
		Zeit.setBounds(20, 232, 201, 26);
		contentPane.add(Zeit);
		
		textField = new JTextField();
		textField.setColumns(10);
		textField.setBounds(244, 199, 86, 20);
